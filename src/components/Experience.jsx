export default function Experience() {
  ...
  return (
    <section id="experience" className="py-10 bg-surface relative">
      <div className="w-full px-4 sm:px-6 lg:px-16 xl:px-20 relative z-10">
        ...
        <div className="space-y-4">
          {experiences.map((exp) => (
            <div
              key={exp.id}
              className="bg-background rounded-xl border border-white/5 p-5 sm:p-6 hover:border-white/15 transition-all duration-300 relative overflow-hidden group"
            >
              {/* Left accent border */}
